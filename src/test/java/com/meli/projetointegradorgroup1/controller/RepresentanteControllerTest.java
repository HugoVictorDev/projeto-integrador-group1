...
public class RepresentanteControllerTest {
    ...
    public void createRepresentante(){
        ...
        Mockito.when(representanteServices.converte(Mockito.any())).thenReturn(representante);
        ...
        represantanteController.createrepResentante(representanteDTO);
    ...
    public void getrepResentanteList(){
        ...
        Mockito.when(representanteServices.converteList(Mockito.anyList())).thenReturn(representanteListDto);
        RepresentanteController represantanteController = new RepresentanteController(representanteServices);
    ...
    public void updateRepresentante(){
        ...
        RepresentanteController represantanteController = new RepresentanteController(representanteServices);
        represantanteController.updateRepresentante(representanteDTO);
