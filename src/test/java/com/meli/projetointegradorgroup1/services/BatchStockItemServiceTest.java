...
class BatchStockItemServiceTest {
    ...
    // - DTOS
    BatchStockItemRequestDTO batchStockItemRequestDTO1 = new BatchStockItemRequestDTO(12,1D,1.0D,0.0D,null);
    BatchStockItemResponseDTO batchStockItemResponseDTO1 = new BatchStockItemResponseDTO(12,1D,1.0D,0.0D,null);
